...
import { ROUTE_INDEX, ROUTE_POOL, ROUTE_SWAP, ROUTE_WRAP, ROUTE_STATS, ROUTE_KPY_RES } from '../../../router/routes';
...
const Header = () => {
  ...
  return (
    <Container>
      <LeftContainer>
        <KDALogo style={{ cursor: 'pointer' }} onClick={() => history.push(ROUTE_KPY_RES)} />
        <Item to={ROUTE_KPY_RES}>kd5</Item>
          ...
          <Popup trigger={<HamburgerIcon />} on="click" offset={[10, 10]} position="bottom right" style={{ padding: 13 }}>
            <HamburgerListContainer>
              ...
              <HamburgerItem to="/"
                ...
                onClick={() => window.open(
                  `https://github.com/Thanos420NoScope/CloudMining`,
                  "_blank",
                  'noopener,noreferrer'
                )}
                >
